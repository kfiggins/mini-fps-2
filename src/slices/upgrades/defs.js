...
export function createStats() {
  return {
    ...
    offerSize: 3, overshield: false, grenadeDmgMult: 1, grenadeDropMult: 1,
    grenadeMaxBonus: 0, clusterBombs: false, clusterCount: 3, blastRadius: 1, enemySlow: 1,
    luck: 0, weaponMult: {}, weaponRate: {}, weaponPierce: {},
...
export const UPGRADES = [
  ...
  { id: 'quartermaster', tier: 'rare', icon: '🃏', name: 'Quartermaster', desc: 'Upgrade offers show 4 choices', unique: true, apply: (s) => { s.offerSize += 1; } },
